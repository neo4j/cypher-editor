...
|  [onEditorCreated?](#oneditorcreated) | (editor: [EditorApi](./cypher-codemirror5.editorapi.md)<!-- -->) =&gt; void |  | <i>(Optional)</i> |
...
|  [onValueChanged?](#onvaluechanged) | (value: string, changes: EditorChange) =&gt; void |  | <i>(Optional)</i> |
